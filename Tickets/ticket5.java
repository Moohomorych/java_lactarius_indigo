/*
Напишите метод rarest, который принимает Мар, ключи которого являются строками, а значения являются целыми числами, в качестве параметра.
...
Ваш метод вернет наименее часто встречающийся возраст.
Рассмотрим переменную словаря m, содержащую следующие пары ключ / значение:
(Alyssa=22, Char=25, Dan=25, Jeff=20, Kasey=20, Kim=20, Mogran=25, Ryan=25, Stef=22)
Три человека имеют возраст 20 лет (Джефф. Кейси и Ким), и два человека - 22 года (Алиеса и Стеф), и четыре человека - 25 лет (Чар, Дэн, Могран и Райан).
